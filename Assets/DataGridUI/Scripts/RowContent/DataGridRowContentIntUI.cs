...
public class DataGridRowContentIntUI : DagaGridRowContentUI, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
        public Text text;
        ...
        public override void UpdateTheme()
        {
            if (text != null && barImage!=null)
            {
                ...
                rectTransform.offsetMin = new Vector2(dataGridUI.theme.rowTheme.controlSpace, 0);
                rectTransform.offsetMax = new Vector2(-dataGridUI.theme.rowTheme.controlSpace, 0);
